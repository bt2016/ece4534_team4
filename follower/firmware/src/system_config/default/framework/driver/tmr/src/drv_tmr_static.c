...
{	
    ...
    /*Set period */	
    PLIB_TMR_Period16BitSet(TMR_ID_2, 6249);
...
{	
    ...
    /*Set period */	
    PLIB_TMR_Period16BitSet(TMR_ID_3, 6249);
...
{	
    ...
    /*Set period */	
    PLIB_TMR_Period16BitSet(TMR_ID_4, 65535);
...
{	
    ...
    /* Select clock source */
    PLIB_TMR_ClockSourceSelect(TMR_ID_5, TMR_CLOCK_SOURCE_EXTERNAL_INPUT_PIN);
    /* Select prescalar value */
    ...
    /*Set period */	
    PLIB_TMR_Period16BitSet(TMR_ID_5, 65535);
