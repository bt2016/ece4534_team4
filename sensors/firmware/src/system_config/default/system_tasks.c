...
static void _IRARRAY_Tasks(void);
...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for IRARRAY Tasks. */
    xTaskCreate((TaskFunction_t) _IRARRAY_Tasks,
                "IRARRAY Tasks",
                1024, NULL, 1, NULL);
...
/*******************************************************************************
  Function:
    void _IRARRAY_Tasks ( void )

  Summary:
    Maintains state machine of IRARRAY.
*/
