...
{	
    ...
    PLIB_OC_PulseWidth16BitSet(OC_ID_1, 210);
}
...
{	
    ...
    PLIB_OC_PulseWidth16BitSet(OC_ID_2, 210);
}
...
{	
    ...
    PLIB_OC_PulseWidth16BitSet(OC_ID_3, 210);
}
...
{	
    ...
    PLIB_OC_PulseWidth16BitSet(OC_ID_4, 210);
}
